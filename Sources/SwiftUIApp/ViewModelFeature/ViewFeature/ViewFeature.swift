...
/// that can be used in methods like ``ViewModelFeature/notify(_:with:storedIn:)``.
///
...
public extension ViewFeature {
  ...
  /// Since your synchronous call to ``ViewModelFeature/notify(_:with:storedIn:)`` requires a bag owned by a different view, the default body implementation will
